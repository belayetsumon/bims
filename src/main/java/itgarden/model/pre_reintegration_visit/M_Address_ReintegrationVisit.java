 ...
 */
@Entity
@Table(name = "Re_M_Address")
public class M_Address_ReintegrationVisit {
    ...
    public M_Address_ReintegrationVisit() {
    }

    public M_Address_ReintegrationVisit(Long id, Address_Type addressType, MotherMasterData motherMasterCode, String co, String vill, String po, District district, Thana thana, String phone, Users createdBy, Users updatedBy) {
        this.id = id;
