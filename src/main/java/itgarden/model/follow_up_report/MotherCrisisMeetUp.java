 ...
 */
@Entity
public class MotherCrisisMeetUp {
    ...
    public MotherCrisisMeetUp() {
    }

    public MotherCrisisMeetUp(Long id, MotherMasterData motherMasterCode, String entrydate, String location, String reason, String challenge, String action, String victimnumber, String supports, String expectedsolvingdate, String remarks, Users createdBy, Users updatedBy) {
        this.id = id;
