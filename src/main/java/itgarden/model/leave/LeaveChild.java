...
public class LeaveChild {
    ...
    public LeaveChild(Long id, M_Child_info childMasterCode, String sectionName, LocalDate leaveFrom, LocalDate leaveTo, String careof, String contactNumber, String address, LocalDate joinningDate, Users createdBy, Users updatedBy) {
        this.id = id;
