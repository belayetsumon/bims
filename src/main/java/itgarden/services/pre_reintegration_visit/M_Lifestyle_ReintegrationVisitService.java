 ...
 */
@Service
public class M_Lifestyle_ReintegrationVisitService {
    @PersistenceContext
    EntityManager em;

    public List<Long> all_M_Lifestyle_Reintegration_Visit_Mother_Id_List() {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<Tuple> cq = cb.createTupleQuery();
        Root<M_Lifestyle_ReintegrationVisit> root = cq.from(M_Lifestyle_ReintegrationVisit.class);
