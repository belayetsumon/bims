 ...
 */
@Service
public class M_Address_ReintegrationVisitService {
    @PersistenceContext
    EntityManager em;

    public List<Long> all_M_Address_Reintegration_Visit_Mother_Id_List() {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<Tuple> cq = cb.createTupleQuery();
        Root<M_Address_ReintegrationVisit> root = cq.from(M_Address_ReintegrationVisit.class);
