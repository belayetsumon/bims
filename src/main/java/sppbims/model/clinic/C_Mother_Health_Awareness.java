 ...
 */
@Entity
public class C_Mother_Health_Awareness {
    ...
    public C_Mother_Health_Awareness() {
    }

    public C_Mother_Health_Awareness(Long id, MotherMasterData motherMasterCode, LocalDate insdate, HealthAwareness healthAwareness, String remark, Users createdBy) {
        this.id = id;
