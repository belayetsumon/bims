...
import sppbims.model.rehabilitations.R_PsychologyMother;
 ...
 */
@Service
public class R_PsychologyMotherService {
...
// Create CriteriaQuery for R_M_HousAllocation
        ...
        Root<R_PsychologyMother> root = cq.from(R_PsychologyMother.class);
...
// Execute the query
    ...
    public List<Map<String, Object>> psychologyCompletedMotherList() {
// Create CriteriaBuilder
        CriteriaBuilder cb = em.getCriteriaBuilder();
...
// Execute the query
    ...
    public List<Map<String, Object>> psychologyCompletedMotherListReport(
            String startDate,
            String endDate
    ) {
// Create CriteriaBuilder
