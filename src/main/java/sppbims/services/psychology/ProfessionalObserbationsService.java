 ...
 */
@Service
public class ProfessionalObserbationsService {

    @PersistenceContext
    EntityManager em;

    public List<Map<String, Object>> professional_Obserbations_Completed_Mother_List( //        LocalDate startDate,
            //        LocalDate endDate
            ) {
        ...
        Root<O_Professional_Obserbations_Mother> root = cq.from(O_Professional_Obserbations_Mother.class);

        // Add conditions (if any)
        List<Predicate> predicates = new ArrayList<>();
//    if (startDate != null) {
//        predicates.add(cb.greaterThanOrEqualTo(root.get("obStartDate"), startDate));
//    }
//    if (endDate != null) {
//        predicates.add(cb.lessThanOrEqualTo(root.get("obStartDate"), endDate));
//    }
        ...
        cq.multiselect(
                ...
                //                root.get("induction").alias("induction"),
...
//            map.put("induction", tuple.get("induction"));
    ...
    public List<Map<String, Object>> professional_Obserbations_Completed_Mother_List_Report(
            String startDate,
            String endDate,
