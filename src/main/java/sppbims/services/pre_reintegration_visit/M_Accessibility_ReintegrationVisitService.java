 ...
 */
@Service
public class M_Accessibility_ReintegrationVisitService {

    @PersistenceContext
    EntityManager em;

    public List<Long> all_m_Accessibility_Reintegration_Visit_Mother_Id_List() {
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaQuery<Tuple> cq = cb.createTupleQuery();
        Root<M_Accessibility_ReintegrationVisit> root = cq.from(M_Accessibility_ReintegrationVisit.class);
