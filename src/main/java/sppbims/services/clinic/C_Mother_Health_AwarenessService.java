...
import sppbims.model.clinic.C_Mother_Health_Awareness;
 ...
 */
@Service
public class C_Mother_Health_AwarenessService {

    @PersistenceContext
    private EntityManager em;

    public List<Map<String, Object>> getAllMotherHealthAwarenessData_report(
            String startDate,
            String endDate
    ) {
        ...
        Root<C_Mother_Health_Awareness> root = cq.from(C_Mother_Health_Awareness.class);
        ...
        cq.multiselect(
                ...
                root.get("motherMasterCode").get("motherMasterCode").alias("motherMasterCode"), // Alias for childMasterCode
                root.get("motherMasterCode").get("motherName").alias("motherName"), // Alias for childMasterCode
