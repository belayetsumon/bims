...
import sppbims.model.clinic.C_Mother_SpecialCare;
 ...
 */
@Service
public class C_Mother_SpecialCareService {

    @PersistenceContext
    private EntityManager em;

    public List<Map<String, Object>> getAllMotherSpecialCareData_report(
            String startDate,
            String endDate
    ) {
        ...
        Root<C_Mother_SpecialCare> root = cq.from(C_Mother_SpecialCare.class);
