 ...
 */
package sppbims.services.impactmeasurement;

import sppbims.model.reintegration_release.ReleaseMother;
import sppbims.model.reintegration_release.ReleaseMotherDTO;
 ...
 */
@Service
public class ShortTermImpactMeasurementService {

    @PersistenceContext
    EntityManager em;

    public List<ReleaseMotherDTO> newListReleaseMotherIdforShortTermImpactMeasurement() {
