...
@Service
@Transactional
public class R_Life_Skill_TrainningService {

    @PersistenceContext
    EntityManager em;

    public List<Map<String, Object>> lifeSkillTrainingsList() {
    ...
    public List<Map<String, Object>> livelihood_training_report_by_mother(
            String motherMasterCode,
            TrainingName trainingName,
            String startDate,
            String endDate
